...
import { FaStar, FaUser, FaSyncAlt, FaServer, FaGlobe } from 'react-icons/fa';
...
const DEFAULT_ITEMS = [
  ...
  {
    label: 'Requests Processed Everyday',
    value: '400+',
    icon: FaSyncAlt,
    href: '#',
  ...
  return (
    <>
      ...
      <nav className={containerClassName} style={style} aria-label="Main navigation">
        ...
        >
          <span
            className={['logo-content', 'hidden', 'invisible items-center justify-center', 'w-[120px] h-full'].join(' ')}
            style={{
              ['--logo-max-height']: '60%',
              ['--logo-max-width']: '100%'
            }}
        ...
        <button
          type="button"
          className={[
            'bubble hidden toggle-bubble menu-btn',
            isMenuOpen ? 'open' : '',
            ...
            {menuItems.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span
                      className="pill-label flex items-center gap-3 sm:gap-4 md:gap-5"
                      style={{
